...
def create_scene_xml(bridge, output_path):
    ...
    bridge_folder = base_dir / "Generated_Bridges" / "BridgeObjects" / bridge_id
    ...
    for idx, obj_file in enumerate(obj_files):
        ...
        xml_parts.append(f'                <param type="string" key="filepath" value="../../Generated_Bridges/BridgeObjects/{bridge_id}/{obj_file}" />')
