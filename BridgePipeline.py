...
from utils import BridgeConfig, generate_bridge_configs, configs_to_records
...
class BridgePipeline:
    ...
    def generate_bridges(self, num_bridges: int, step: int, seed = None, overhang_m: float = 1.0) -> List[BridgeConfig]:
        """Create bridge configs and keep them in-memory."""

        configs = generate_bridge_configs(count=num_bridges, step=step, seed=seed, overhang_m=overhang_m,)
